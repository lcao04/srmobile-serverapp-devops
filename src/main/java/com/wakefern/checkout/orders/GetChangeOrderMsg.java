...
public class GetChangeOrderMsg extends BaseService {
	
	private final static Logger logger = Logger.getLogger(GetChangeOrderMsg.class);
    ...
    public Response getResponse(
        ...
        try {		
            ...
            return this.createValidResponse(jsonResponse);
	        	...
	        	LogUtil.addErrorMaps(e, MwgErrorType.ORDER_GET_CHANGE_ORDER_MESSAGE);
