...
public class DeleteChangeOrder extends BaseService {
	
	private final static Logger logger = Logger.getLogger(DeleteChangeOrder.class);
    ...
    public Response getResponse(
        ...
        try {		
            ...
            return this.createValidResponse(jsonResponse);
	        	...
	        	LogUtil.addErrorMaps(e, MwgErrorType.ORDER_DELETE_CHANGE_ORDER);
